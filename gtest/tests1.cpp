...
// TEST(TableTest, TestingCollisionResolution)
// {
// 	WordSet ws;
// 	ws.insert("dbc");
// 	ws.insert("ariaab");
...
// 	// ws.insert("alex");
// 	ws.insert("eric");
// 	ws.insert("eriaafafadz");
// 	EXPECT_TRUE(ws.contains("dbc"));
// 	EXPECT_TRUE(ws.contains("ariaab"));
// 	// EXPECT_TRUE(ws.contains("boo"));
// 	// EXPECT_TRUE(ws.contains("alex"));
// 	// EXPECT_TRUE(ws.contains("eric"));
// 	EXPECT_FALSE(ws.contains("whassssup"));
